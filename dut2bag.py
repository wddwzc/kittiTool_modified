...
import utils
from dut_odometry import odometry
...
def main():
    ...
    parser.add_argument("-s", "--sequence", help = "sequence of the odometry dataset, option is only for ODOMETRY datasets.")
    ...
    output_file = os.path.join(output_dir, "dut_odometry_{}.bag".format(velo_sequence))
    ...
    velo_frame_id = 'laser_link'
    velo_topic = '/dut/lslidar/point'
    label_topic = '/dut/lslidar/pointlabel'
    veloall_topic = '/dut/lslidar/pointall'
    # rosbag settings
